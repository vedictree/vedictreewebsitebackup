$(document).ready(function () {
  ...
  if ($.isFunction($.fn.slick)) {
    ...
    $('.blog-caro').slick({
      ...
      focusOnSelect: true,
      vertical: false,
      prevArrow:"<button type='button' class='slick-prev'><img src='https://www.vedictreeschool.com/assets/website/webinar/images/arrow-left.png' alt='Arrow Left'></button>",
      nextArrow:"<button type='button' class='slick-next'><img src='https://www.vedictreeschool.com/assets/website/webinar/images/arrow-right.png' alt='Arrow Right'></button>",
      responsive: [
      {
        breakpoint: 981,
        settings: {
