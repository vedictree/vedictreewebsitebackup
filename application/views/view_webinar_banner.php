                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered  " style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                               <?php if($webinar_banners){
                                                $i=1;
                                                foreach ($webinar_banners as $key => $value) { 
                                                    // echo "<pre>";
                                                    // print_r($value);
                                                ?> 
                                            <tr>
                                                ...
                                                <td><img width="50" src="<?php echo base_url('uploads/webinar_banner/'.$value['banner']); ?>" /></td>
                                                <td>
                                                     <form method="POST" action="<?php echo base_url('adminseo/delete_banner_webinar_details'); ?>">
                                                         <input type="hidden" value="<?php echo  $value['webinar_banner_id']; ?>" name="bannerId" />        
