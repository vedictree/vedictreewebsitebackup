                                ...
                                <div class="card">
                                      <div class="card-body">
                                       ...
                                       <?php if ($this->session->flashdata('msg')) { ?>
                                        ...
                                        <?php } ?>
                                        <form method="POST"  action="<?php echo  base_url("adminseo/insert_youtube_review")?>">
                                            <div class="row">
                                            <div class="col-md-12">
                                               ...
                                               <div class="form-group" >
                                                    <div class="form-group">
                                                        ...
                                                        <input type="url" class="form-control" id="image_input_link" name="image_input_link" placeholder="Enter Image Link" >
                                                    </div>
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                   <div class="form-group" >
                                                        <div class="form-group">
                                                            ...
                                                            <input type="url" class="form-control" id="youtube_input_link" name="youtube_input_link" placeholder="Enter youtube link"  >
                                                        </div>
