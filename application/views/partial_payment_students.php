    ...
    .thclass{
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                        <div class="card">
                                      <div class="card-body">
                                        <form method="POST" action="<?php echo base_url('dashboard/partial_payment_students'); ?>">
                                            <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="datatables" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $value['final_fees'] - $value['payAmount'] - $value['augustoffer'] ; ?></td>
                                                ...
                                                <td><?php echo $value['final_fees']; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="sendPaymentreminder" id="<?php echo $value['studId']; ?>"><i style="font-size: 21px; color:#626ed4;" class="fas fa-sms"></i></span>
                                                    </td>
      ...
      <script type="text/javascript">
           $(document).ready(function() {
                ...
                $(".sendPaymentreminder").click(function(){
                    ...
                    $.ajax({
                        ...
                        type:"POST",
                        data:{studId:studId},
                        url:"<?php echo base_url('dashboard/sendPaymentreminder')?>",
                        success:function(res){
    // console.log(res);
    // return false;
                            if(res==1){
                                swal({
                                      title: "Sent reminder successfully!",
                                      text: "You clicked the button!",
                                      icon: "success",
                                      button: "ok",
                                    });
                                ...
                                swal({
                                      title: "Sms Pack or Data Not Found!",
                                      text: "You clicked the button!",
                                      icon: "success",
                                      button: "ok",
                                    });
