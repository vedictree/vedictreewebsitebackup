                    ...
                    <div class="container-fluid">
                                ...
                                <div class="card">
                                      <div class="card-body">
                                        ...
                                        <a href="<?php echo base_url('dashboard/promocode_list_student');?>"  style="float: right;top: -40px;position: relative;" class="btn btn-primary">Refresh</a>
                                        <form method="POST" action="<?php echo base_url('dashboard/promocode_list_student'); ?>">
                                            <input type="hidden" name="allocate" value="search">
                                            <div class="row">
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="form-group">
                                                        <label for="username"> Enter Mobile Number</label>
                                                        <input type="text" class="form-control" name="studentMobile" maxlength="10" value="<?php echo set_value('studentMobile'); ?>" placeholder="Enter Student Mobile">
                                                ...
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" name="studentEmail" placeholder="Enter Student Email" value="<?php echo set_value('studentEmail'); ?>">
                                                        <span style="color:red"><?php echo form_error('studentEmail');?></span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="form-group">
                                                        <label for="username"> Enter Promo Code </label>
                                                        <input type="text" class="form-control" name="promoCode" placeholder="Enter Promo Code" value="<?php echo set_value('promoCode'); ?>">
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <form method="POST" action="<?php echo base_url('dashboard/promocode_list_student_allocate'); ?>">
