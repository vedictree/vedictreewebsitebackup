                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 8%"><?php echo $value['date']; ?></td>
                                        <td><img class="img-rounded" width="180" height="130" src="<?php echo  base_url('uploads/blogs_images/'.$value['file_upload']);?>" /></td>
                                        <td style="width: 40%"><?php echo $value['description']; ?></td>
                                        <td style="width: 1%">
                                            <div class="d-flex">
                                                <form method="POST" action="<?php echo base_url('adminseo/edit_blogs'); ?>">
                                                    <input type="hidden" value="<?php echo  $value['id'] ?>" name="blog_id" />   
                                                   <button class="btn btn-sm"><i style="font-size: 22px;color:#626ed4;" class="mdi mdi-account-edit-outline"></i></button>
                                                </form>
                                                <form method="POST" action="<?php echo base_url('adminseo/delete_blogs'); ?>">
                                                    <input type="hidden" value="<?php echo  $value['id'] ?>" name="blog_id" />        
